...
std::mutex m_buf;
Eigen::Quaterniond vel2body(-0.00432617571442, -0.160765217614, 0.00432617571442, 0.98697371455);
Eigen::Quaterniond vel2b = vel2body.normalized();
Eigen::Matrix3d v2b = vel2b.toRotationMatrix();;
...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    odometry.child_frame_id = "/global_odometry";
    ...
    std::ofstream foutC("/home/zc/catkin_yt/src/fusion_localization/results/lo_global.txt", ios::app);
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_GPS = n.subscribe("/latlng", 100, GPS_callback);
    ros::Subscriber sub_vio = n.subscribe("/aft_mapped_to_init", 100, vio_callback);
